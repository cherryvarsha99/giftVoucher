...
public final class SimpleListItemBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView simpleListItem;

  private SimpleListItemBinding(@NonNull TextView rootView, @NonNull TextView simpleListItem) {
  ...
  public static SimpleListItemBinding bind(@NonNull View rootView) {
    ...
    TextView simpleListItem = (TextView) rootView;

    return new SimpleListItemBinding((TextView) rootView, simpleListItem);
  }
}
